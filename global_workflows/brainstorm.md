...
- Phân biệt rõ fact đã kiểm chứng, user-provided fact, assumption và recommendation.
- Không bịa số liệu thị trường, testimonial, đối thủ, revenue hoặc trend.
- Claim chưa kiểm chứng phải đưa vào danh sách "cần validate", không đưa vào brief như sự thật.
