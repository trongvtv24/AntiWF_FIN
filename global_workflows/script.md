...
Trước khi research, viết kịch bản, tạo YouTube package hoặc visual prompts:
...
- Visual prompt không được tạo "phantom content" ngoài nội dung script.

## Khi nào dùng
- Khi muốn viết kịch bản video mới cho kênh
- Khi cần brainstorm topic mới
- Khi cần tạo AI image prompts cho video
...
### Giai đoạn 5: AI Image Prompts & Video Production 🎨

16. Tạo AI image prompts cho mỗi scene:
    - Dùng base prompt chuẩn (từ SKILL.md)
    - 25-35 scenes (mỗi scene ~20-30 giây)
    - Mô tả emotion, hành động, text on screen
17. Lưu file: `[Topic]_AI_Prompts.md`
18. Tạo thêm file `.txt` (chỉ prompts, không ghi chú)
...
| `[Topic]_AI_Prompts.md` | AI image prompts cho mọi scene |
| `[Topic]_AI_Prompts.txt` | Prompts only (không ghi chú cảnh) |
