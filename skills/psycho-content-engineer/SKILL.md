...
- Không tự tạo proof, testimonial, case study, số liệu, deadline, scarcity, hoặc authority claim.
- Chỉ dùng social proof, khan hiếm, kết quả, hoặc cam kết khi user cung cấp bằng chứng hoặc xác nhận.
- Claim chưa kiểm chứng phải được giữ nhãn assumption/claim và không dùng như fact trong bản final.
