...
SAFE_SEGMENT_RE = re.compile(r"[^a-z0-9_-]+")


def sanitize_path_segment(value: str, default: str = "default") -> str:
    """Sanitize user-provided path segment to prevent path traversal."""
    if not value:
        return default
    normalized = SAFE_SEGMENT_RE.sub("-", str(value).lower()).strip("-_")
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    ...
    project_slug = sanitize_path_segment(project_name, "default")
    ...
    if page:
        page_slug = sanitize_path_segment(page, "page")
