...
Stacks: see `--help` output (loaded from data/stacks/*.csv)
...
from design_system import generate_design_system, sanitize_path_segment
...
if __name__ == "__main__":
    ...
    if args.design_system:
        ...
        if args.persist:
            project_slug = sanitize_path_segment(args.project_name, "default")
            print("\n" + "=" * 60)
